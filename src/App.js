           ...
           <a href="/" className="govuk-header__link govuk-header__link--homepage">
             <span className="govuk-header__logotype">
               <svg role="presentation" focusable="false" className="govuk-header__logotype-crown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 132 97" height={30} width={36}>
                 ...
                 <image src="/assets/images/govuk-logotype-crown.png" xlinkHref className="govuk-header__logotype-crown-fallback-image" width={36} height={32} />
               </svg>
...
<h1 className="govuk-heading-s">Journal entries</h1>
